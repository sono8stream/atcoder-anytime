...
const StartPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <Header as="h2">
        <Header.Content>
          Anytime <span style={{ color: 'red' }}>Rated</span> in AtCoder
          contests!
        </Header.Content>
        <Header.Subheader>
          {isEnglish ? (
            <>
              ...
              of a virtual contest in AtCoder.
              <br />
      ...
      <List ordered={true}>
        ...
        <List.Item>
          {isEnglish ? (
            <>Create user by specifying your user name in AtCoder</>
          ) : (
            <>AtCoderのユーザー名を指定してユーザー登録</>
          )}
        </List.Item>
